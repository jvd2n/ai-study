...
xx = Dense(32, activation='relu')(input1)
...
model.fit(x_train, y_train, epochs=1000, batch_size=64, validation_split=0.02, verbose=1)
...
'''
ic| loss: 0.003331440268084407
ic| r2: 0.9999950698079466
ic| rmse: 0.057718630703362216
'''