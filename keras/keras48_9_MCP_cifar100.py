...
cp = ModelCheckpoint(monitor='val_loss', save_best_only=True, mode='auto', 
                     filepath='./_save/ModelCheckPoint/keras48_9_MCP_cifar100.hdf5')

start_time = time.time()
# model.fit(x_train, y_train, epochs=10, batch_size=512, verbose=2, validation_split=0.2, callbacks=[es, cp])
duration_time = time.time() - start_time

# model.save('./_save/ModelCheckPoint/keras48_9_MCP_cifar100.h5')
# model = load_model('./_save/ModelCheckPoint/keras48_9_MCP_cifar100.h5')   # save_model
model = load_model('./_save/ModelCheckPoint/keras48_9_MCP_cifar100.hdf5')  # CheckPoint
...
save_model_h5
ic| duration_time: 312.8417363166809
ic| loss[0]: 3.6285178661346436
ic| loss[1]: 0.27320000529289246
...
ic| duration_time: 0.0
ic| loss[0]: 3.040384531021118
ic| loss[1]: 0.25859999656677246
'''
