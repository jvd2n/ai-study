...
# np.save('./_save/_npy/ygc_14_train_x.npy', arr=train_gen[0][0])
np.save('./_save/_npy/ygc_14_train_x.npy', arr=x_train)
# np.save('./_save/_npy/ygc_14_train_y.npy', arr=train_gen[0][1])
np.save('./_save/_npy/ygc_14_train_y.npy', arr=y_train)
np.save('./_save/_npy/ygc_14_valid_x.npy', arr=valid_gen[0][0])
np.save('./_save/_npy/ygc_14_valid_y.npy', arr=valid_gen[0][1])
np.save('./_save/_npy/ygc_14_test_x.npy', arr=test_gen[0][0])
np.save('./_save/_npy/ygc_14_test_y.npy', arr=test_gen[0][1])
