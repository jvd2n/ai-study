...
x_augmented = x_augmented.reshape(x_augmented.shape[0], 100, 100, 3)
x_train = train_gen[0][0].reshape(train_gen[0][0].shape[0], 100, 100, 3)
...
np.save('./_save/_npy/ygc_14_aug_train_x.npy', arr=x_train)
# np.save('./_save/_npy/ygc_aug_train_y.npy', arr=train_gen[0][1])
np.save('./_save/_npy/ygc_14_aug_train_y.npy', arr=y_train)
np.save('./_save/_npy/ygc_14_aug_valid_x.npy', arr=valid_gen[0][0])
np.save('./_save/_npy/ygc_14_aug_valid_y.npy', arr=valid_gen[0][1])
np.save('./_save/_npy/ygc_14_aug_test_x.npy', arr=test_gen[0][0])
np.save('./_save/_npy/ygc_14_aug_test_y.npy', arr=test_gen[0][1])
