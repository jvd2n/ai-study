...
print(train_imgs.shape, train_seqs.shape, train_labels.shape, val_imgs.shape, val_seqs.shape, val_labels.shape)
...
test_imgs = ('./dacon/_data/3_scientific/test_imgs/'+test.uid+'.png').to_numpy()
...
submission.to_csv('./dacon/_output/3_scientific/dacon_baseline.csv', index=False)
