...
# layer4
w4 = tf.compat.v1.get_variable('w4', shape=[2, 2, 128, 64],)# initializer=tf.compat.v1.contrib.layers.xavier_initializer())
...
# layer5 DNN
w5 = tf.compat.v1.get_variable('w5', shape=[2*2*64, 64],)# initializer=tf.compat.v1.contrib.layers.xavier_initializer())
...
# layer6 DNN
w6 = tf.compat.v1.get_variable('w6', shape=[64, 32],)# initializer=tf.compat.v1.contrib.layers.xavier_initializer())
