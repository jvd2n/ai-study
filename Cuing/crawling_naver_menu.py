...
class Nutrition(object):
    ...
    def scrap_name(self):
        ...
        for i in range(1, 3):
            self.url = f'https://terms.naver.com/list.naver?cid=59320&categoryId=59320&page={i}'  # 1 페이지부터 3페치지 차례대로 링크로 이동
            ...
            for i, j, k in zip(self.new_food_nut, self.new_food_gram, self.new_food_kcal):
                temp = i + ',' + j + ',' + k
                self.final_food_nut.append(temp)                # nutrition 칼로리, 1회 제공량, 영양성분을 하나의 변수로 합침
