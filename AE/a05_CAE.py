...
x_train_1 = x_train.reshape(60000, 28, 28, 1).astype('float')/255
x_train_2 = x_train.reshape(60000,  28 * 28).astype('float')/255
...
model1.fit(x_train_1, x_train_2, epochs=10, batch_size=32)
model2.fit(x_train_1, x_train_2, epochs=10, batch_size=32)
