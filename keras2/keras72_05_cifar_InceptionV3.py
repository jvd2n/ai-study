...
for dt_key, dt_val in DATASETS.items():
    ...
    for tf_key, tf_val in TRAINABLE.items():
        for fg_key, fg_val in FLATTEN_GAP.items():
            transfer_learning = InceptionV3(weights='imagenet', include_top=False, input_shape=(75, 75, 3))
...
'''
InceptionV3
[1] cifar_10_True__Flatten :: loss= 0.8193, acc= 0.8322
[2] cifar_10_True__GAP__2D :: loss= 0.795, acc= 0.8246
[3] cifar_10_False_Flatten :: loss= 2.4586, acc= 0.32
[4] cifar_10_False_GAP__2D :: loss= 2.4277, acc= 0.3109
[5] cifar100_True__Flatten :: loss= 2.3792, acc= 0.5401
[6] cifar100_True__GAP__2D :: loss= 2.5116, acc= 0.5228
[7] cifar100_False_Flatten :: loss= 4.6053, acc= 0.0101
[8] cifar100_False_GAP__2D :: loss= 4.6057, acc= 0.01
'''