...
def solution_model():
    ...
    model = tf.keras.models.Sequential([
        # YOUR CODE HERE.
        # Whatever your first layer is, the input shape will be [None,1]
        # when using the Windowed_dataset above, depending on the layer type chosen
    ...
    model.fit(
        ...
        #     monitor='loss', patience=2, mode='min', verbose=1
        # )]
    )
    return model
