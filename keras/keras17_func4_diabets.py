...
dense2 = Dense(256, activation='selu')(dense1)
dense3 = Dense(128, activation='selu')(dense2)
dense4 = Dense(64, activation='selu')(dense3)
dense5 = Dense(32, activation='selu')(dense4)
output1 = Dense(1, activation='selu')(dense5)
...
model.fit(x_train, y_train, epochs=100, batch_size=32, verbose=2, validation_split=0.02, shuffle=True)
