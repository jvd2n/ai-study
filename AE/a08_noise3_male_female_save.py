...
np.save('./_save/_npy/a08_noise3_train_x.npy', arr=train_gen[0][0])
np.save('./_save/_npy/a08_noise3_train_y.npy', arr=train_gen[0][1])
np.save('./_save/_npy/a08_noise3_valid_x.npy', arr=valid_gen[0][0])
np.save('./_save/_npy/a08_noise3_valid_y.npy', arr=valid_gen[0][1])
