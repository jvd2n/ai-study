import os, re, json, tqdm, datetime
...
#1 Data
INPUT_PATH = './dacon/_data/2_climate/'
OUTPUT_PATH = './dacon/_output/2_climate/'
...
es = EarlyStopping(monitor='val_acc', min_delta=0.0001, patience=5, verbose=1)
